// ID 1
app.controller('opinionInternacional',function ($scope,$http) {
  ...
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/1/tweetsInternacionalesImportantes'
   }).then(function (data){
...
//ID 2
app.controller('opinionInternacional2',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/2/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional3',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/3/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional4',function ($scope,$http) {
  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/4/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional5',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/5/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional6',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/6/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional7',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/7/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional8',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/8/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional9',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/9/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional10',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/10/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional11',function ($scope,$http) {
  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/11/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional12',function ($scope,$http) {
  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/12/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional13',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/13/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional14',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/14/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
...
app.controller('opinionInternacional15',function ($scope,$http) {

  $scope.personas=[];
  $http({
      method: 'GET',
      url: 'http://localhost:8080/votweet-backend-master/candidatos/15/tweetsInternacionalesImportantes'
   }).then(function (data){
        $scope.personas=data.data;
   },function (error){
